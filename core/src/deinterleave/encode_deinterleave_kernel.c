                        ...
                        size_t nbElts, size_t eltWidth)
{
    ...
    switch (eltWidth) {
        case 1: DEINTERLEAVE_SPLIT(uint8_t); break;
        case 2: DEINTERLEAVE_SPLIT(uint16_t); break;
        case 4: DEINTERLEAVE_SPLIT(uint32_t); break;
        case 8: DEINTERLEAVE_SPLIT(uint64_t); break;
        default: {
