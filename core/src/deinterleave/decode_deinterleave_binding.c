...
#include "graph_deinterleave.h" // GEOZL_DEINTERLEAVE_GRAPH
...
const ZL_TypedDecoderDesc deinterleave_decoder_desc = {
    .gd          = GEOZL_DEINTERLEAVE_GRAPH,
    .transform_f = DI_geozl_deinterleave,
