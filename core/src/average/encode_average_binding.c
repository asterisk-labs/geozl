...
#include "geozl/ctids.h"          // GEOZL_CTID_AVERAGE
...
const ZL_TypedEncoderDesc average_encoder_desc = {
    .gd          = GEOZL_NUM1TO1_GRAPH(GEOZL_CTID_AVERAGE),
...
ZL_Report EI_geozl_average(ZL_Encoder* eictx, const ZL_Input* in)
{
    ...
    average_encode(ZL_Output_ptr(out), ZL_Input_ptr(in), width, nbElts, eltWidth);
