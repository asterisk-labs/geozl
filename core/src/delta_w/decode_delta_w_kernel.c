        ...
        size_t eltWidth)
{
    ...
    switch (eltWidth) {
        case 1: DELTA_W_RUN(uint8_t, scan8); break;
        case 2: DELTA_W_RUN(uint16_t, scan16); break;
        case 4: DELTA_W_RUN(uint32_t, scan32); break;
        case 8: DELTA_W_RUN(uint64_t, scan64); break;
        default: break;
    }
}
