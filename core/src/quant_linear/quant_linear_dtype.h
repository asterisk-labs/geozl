...
// decoder rebuilds it. The index stream between encode and decode is always a
// signed integer, the original type only matters at the two ends. The value is
// the wire code, frozen.
typedef enum {
  QL_U8 = 0,
  QL_U16 = 1,
  QL_U32 = 2,
