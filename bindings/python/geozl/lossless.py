...
_DeltaWEncoder, DeltaWDecoder = _make_codec(
    _DELTA_W_CTID, "geozl.lossless.delta_w",
    lib.geozl_delta_w_encode, lib.geozl_delta_w_decode)
_DeltaNEncoder, DeltaNDecoder = _make_codec(
    _DELTA_N_CTID, "geozl.lossless.delta_n",
    lib.geozl_delta_n_encode, lib.geozl_delta_n_decode)
_PlanarEncoder, PlanarDecoder = _make_codec(
    _PLANAR_CTID, "geozl.lossless.planar",
    lib.geozl_planar_encode, lib.geozl_planar_decode)
